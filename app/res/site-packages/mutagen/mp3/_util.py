...
from mutagen._compat import cBytesIO, iterbytes, xrange
from mutagen._util import BitReader, cdata
...
class LAMEHeader(object):
    ...
    def guess_settings(self, major, minor):
        ...
        if self.vbr_method == 2:
            ...
            preset_key = (self.vbr_quality, self.quality, self.vbr_method, self.lowpass_filter, self.ath_type)
    ...
    def parse_version(cls, fileobj):
        ...
        if (major, minor) < (3, 90) or ((major, minor) == (3, 90) and data[-11:-10] == b"("):
...
class XingHeader(object):
    ...
    def __init__(self, fileobj):
        ...
        try:
            self.lame_version, self.lame_version_desc, has_header = LAMEHeader.parse_version(fileobj)
            if has_header:
