...
from ._compat import PY2, chr_, integer_types, iterbytes, iteritems, izip, reraise, text_type, xrange
...
def is_fileobj(fileobj):
    ...
    return not (isinstance(fileobj, (text_type, bytes)) or hasattr(fileobj, "__fspath__"))
...
class cdata(object):
    ...
    bitswap = b"".join(chr_(sum(((val >> i) & 1) << (7 - i) for i in xrange(8))) for val in xrange(256))
