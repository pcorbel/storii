...
from mutagen._util import BitReader, BitReaderError, MutagenError, convert_error, enum, loadfile
...
class AC3Info(StreamInfo):
    ...
    def pprint(self):
        return u"%s, %d Hz, %.2f seconds, %d channel(s), %d bps" % (self.codec, self.sample_rate, self.length, self.channels, self.bitrate,)
...
class AC3(FileType):
    ...
    def score(filename, fileobj, header):
        return header.startswith(b"\x0b\x77") * 2 + (endswith(filename, ".ac3") or endswith(filename, ".eac3"))
