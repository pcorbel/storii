...
class OggOpusInfo(StreamInfo):
    ...
    def __init__(self, fileobj):
        ...
        (version, self.channels, pre_skip, orig_sample_rate, output_gain, channel_map) = struct.unpack("<BBHIhB", page.packets[0][8:19])
...
class OggOpusVComment(VCommentDict):
    ...
    def __get_comment_pages(self, fileobj, info):
        ...
        page = OggPage(fileobj)
        while (info.serial != page.serial) or not page.packets[0].startswith(b"OpusTags"):
            page = OggPage(fileobj)
