...
from ._compat import PY2, PY3, text_type
...
class EasyMP4Tags(DictMixin, Tags):
    ...
    filename = property(lambda s: s.__mp4.filename, lambda s, fn: setattr(s.__mp4, "filename", fn))
...
for atomid, key in {"\xa9nam": "title", "\xa9alb": "album", "\xa9ART": "artist", "aART": "albumartist", "\xa9day": "date", "\xa9cmt": "comment", "desc": "description", "\xa9grp": "grouping", "\xa9gen": "genre", "cprt": "copyright", "soal": "albumsort", "soaa": "albumartistsort", "soar": "artistsort", "sonm": "titlesort", "soco": "composersort",}.items():
    EasyMP4Tags.RegisterTextKey(key, atomid)

for name, key in {"MusicBrainz Artist Id": "musicbrainz_artistid", "MusicBrainz Track Id": "musicbrainz_trackid", "MusicBrainz Album Id": "musicbrainz_albumid", "MusicBrainz Album Artist Id": "musicbrainz_albumartistid", "MusicIP PUID": "musicip_puid", "MusicBrainz Album Status": "musicbrainz_albumstatus", "MusicBrainz Album Type": "musicbrainz_albumtype", "MusicBrainz Release Country": "releasecountry",}.items():
