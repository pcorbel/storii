...
class OptimFROGInfo(StreamInfo):
    ...
    def __init__(self, fileobj):
        ...
        if data_size != 12 and data_size < 15:
            raise OptimFROGHeaderError("not an OptimFROG file")
        (total_samples, total_samples_high, sample_type, self.channels, self.sample_rate) = struct.unpack("<IHBBI", header[8:20])
...
class OptimFROG(APEv2File):
    ...
    def score(filename, fileobj, header):
        ...
        return header.startswith(b"OFR") + endswith(filename, b".ofr") + endswith(filename, b".ofs")
