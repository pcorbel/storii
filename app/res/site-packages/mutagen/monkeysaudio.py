...
class MonkeysAudioInfo(StreamInfo):
    ...
    def __init__(self, fileobj):
        ...
        if self.version >= 3980:
            (blocks_per_frame, final_frame_blocks, total_frames, self.bits_per_sample, self.channels, self.sample_rate,) = struct.unpack("<IIIHHI", header[56:76])
        else:
            ...
            elif self.version >= 3900 or (self.version >= 3800 and compression_level == 4):
    ...
    def pprint(self):
        return u"Monkey's Audio %.2f, %.2f seconds, %d Hz" % (self.version, self.length, self.sample_rate)
