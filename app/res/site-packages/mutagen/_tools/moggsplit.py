...
def main(argv):
    ...
    parser.add_option(
        "--extension", dest="extension", default="ogg", metavar="ext", help="use this extension (default 'ogg')",
    )
    parser.add_option(
        "--pattern", dest="pattern", default="%(base)s-%(stream)d.%(ext)s", metavar="pattern", help="name files using this pattern",
    )
    parser.add_option(
        "--m3u", dest="m3u", action="store_true", default=False, help="generate an m3u (playlist) file",
    )
