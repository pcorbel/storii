...
from mutagen._util import MutagenError, cdata, loadfile, resize_bytes, seek_end

from ._compat import cBytesIO, chr_, izip, reraise, xrange
...
class OggPage(object):
    ...
    def __init__(self, fileobj=None):
        ...
        if oggs != b"OggS":
            raise error("read %r, expected %r, at 0x%x" % (oggs, b"OggS", fileobj.tell() - 27))
    ...
    def write(self):
        ...
        data = [struct.pack("<4sBBqIIi", b"OggS", self.version, self.__type_flags, self.position, self.serial, self.sequence, 0)]
