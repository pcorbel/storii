...
class EasyID3(DictMixin, Metadata):
    ...
    delete = property(lambda s: s.__id3.delete, lambda s, v: setattr(s.__id3, "delete", v))
...
for frameid, key in iteritems({"TALB": "album", "TBPM": "bpm", "TCMP": "compilation", "TCOM": "composer", "TCOP": "copyright", "TENC": "encodedby", "TEXT": "lyricist", "TLEN": "length", "TMED": "media", "TMOO": "mood", "TIT2": "title", "TIT3": "version", "TPE1": "artist", "TPE2": "albumartist", "TPE3": "conductor", "TPE4": "arranger", "TPOS": "discnumber", "TPUB": "organization", "TRCK": "tracknumber", "TOLY": "author", "TSO2": "albumartistsort", "TSOA": "albumsort", "TSOC": "composersort", "TSOP": "artistsort", "TSOT": "titlesort", "TSRC": "isrc", "TSST": "discsubtitle", "TLAN": "language",}):  # iTunes extension  # iTunes extension  # iTunes extension
    EasyID3.RegisterTextKey(key, frameid)

EasyID3.RegisterKey("genre", genre_get, genre_set, genre_delete)
EasyID3.RegisterKey("date", date_get, date_set, date_delete)
EasyID3.RegisterKey("originaldate", original_date_get, original_date_set, original_date_delete)
EasyID3.RegisterKey("performer:*", performer_get, performer_set, performer_delete, performer_list)
EasyID3.RegisterKey("musicbrainz_trackid", musicbrainz_trackid_get, musicbrainz_trackid_set, musicbrainz_trackid_delete)
