...
class MusepackInfo(StreamInfo):
    ...
    def __parse_sv8(self, fileobj):
        ...
        if mandatory_packets:
            raise MusepackHeaderError("Missing mandatory packets: %s." % ", ".join(map(repr, mandatory_packets)))
    ...
    def pprint(self):
        ...
        return u"Musepack SV%d, %.2f seconds, %d Hz, %d bps%s" % (self.version, self.length, self.sample_rate, self.bitrate, rg_data,)
...
class Musepack(APEv2File):
    ...
    def score(filename, fileobj, header):
        ...
        return header.startswith(b"MP+") + header.startswith(b"MPCK") + endswith(filename, b".mpc")
